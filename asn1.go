...
// // A asn1.StructuralError suggests that the ASN.1 data is valid, but the Go type
// // which is receiving it doesn't match.
// type asn1.StructuralError struct {
// 	Msg string
// }

// func (e asn1.StructuralError) Error() string { return "asn1: structure error: " + e.Msg }

// // A asn1.SyntaxError suggests that the ASN.1 data is invalid.
